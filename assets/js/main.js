// ============================================
//   SANAV Sarees — Main JavaScript
// ============================================

// ===== SITE CONFIG =====
const WHATSAPP_NUMBER = '917777777777';
const SHOW_SIZE_GUIDE = false;
var SITE_URL = 'https://sanavsarees.com';
var INSTAGRAM_HANDLE = '@sanav_sarees';
var DELIVERY_ITEMS = [];
...
fetch('data/products.json')
  ...
  if (item.sizes) {
    ...
    sizeArr.forEach(function(s) {
      ...
      btn.type = 'button';
      btn.textContent = sz;
      btn.style.cssText = 'padding:6px 14px;border:1.5px solid #7B2D3B;border-radius:20px;background:transparent;color:#7B2D3B;font-size:0.8rem;cursor:pointer;transition:all 0.2s;font-weight:500;';
      btn.addEventListener('click', function() {
        selectedSize = sz;
        sizeBtns.forEach(function(b) {
          b.style.background = 'transparent';
          b.style.color = '#7B2D3B';
        });
        btn.style.background = '#7B2D3B';
        btn.style.color = '#fff';
      });
      sizeBtns.push(btn);
  ...
  waShareBtn.addEventListener('click', function(e) {
    e.stopPropagation();
    var msg =
      '\uD83C\uDF38 Hey! Check out this gorgeous saree from SANAV Sarees!\n\n' +
      '*' + item.name + '*\n' +
  ...
  igShareBtn.addEventListener('click', function(e) {
    ...
    var caption =
      ...
      '\uD83D\uDCB0 Price: ' + item.price + '\n\n' +
      '\uD83D\uDED2 Shop: ' + SITE_URL + '\n\n' +
      '#SANAVSarees #SilkSarees #Kanchipuram #TraditionalSaree #IndianSaree #SareeLove #WhatsAppShopping';
    openIgModal(caption);
  });
    ...
    if (site.catalogue_enabled && catalogueSection) {
      ...
      if (site.catalogue_mode === 'whatsapp_business') {
        ...
        var catMsg = site.catalogue_message ||
          'Hi SANAV Sarees! I\'d like to receive your full saree catalogue. Please send it to me. Thank you!';
